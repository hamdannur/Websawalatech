...
const CTAContent = ({ wide }: { wide?: boolean }) => (
  <div className="flex flex-col gap-6 items-center text-center w-full">
    <SawalaLogo />
    <div className={`flex flex-col gap-2 ${wide ? "" : "max-w-[328px]"}`}>
      <h2 className="text-white text-[36px] leading-normal tracking-[-0.72px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
        Let's Build The Right Solution for Your Business
      </h2>
      <p className="text-white text-[16px] leading-[24px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
        Work with our team to develop systems and technology that support your long-term growth.
      </p>
    </div>
    <button className="bg-blue-600 text-white h-[50px] rounded-full w-[200px] text-[16px] hover:bg-blue-700 transition-colors" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>
...
export function CTASection() {
  return (
    <>
      {/* ── Mobile ── */}
      <section className="md:hidden w-full bg-[#0f285e] flex flex-col items-center justify-center px-[16px] py-[60px]" style={{ minHeight: 500 }}>
        <CTAContent />
      </section>

      {/* ── Tablet ── */}
      <section className="hidden md:flex lg:hidden w-full bg-[#0f285e] flex-col items-center justify-center px-[32px] py-[60px]" style={{ height: 500 }}>
        <CTAContent wide />
      </section>

      {/* ── Desktop ── */}
      <section className="hidden lg:flex w-full min-h-[428px]">
        <div className="relative flex-1 flex flex-col items-center justify-center overflow-hidden bg-[#0f285e]">
          <div className="relative z-10 flex flex-col gap-6 items-center text-center px-[100px] py-[60px]">
            <SawalaLogo />
            <div className="flex flex-col gap-2">
              <h2 className="text-white text-[36px] leading-normal tracking-[-0.72px] max-w-[540px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700 }}>
                Let's Build The Right Solution for Your Business
              </h2>
              <p className="text-white text-[16px] leading-[24px] max-w-[540px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                Work with our team to develop systems and technology that support your long-term growth.
              </p>
            </div>
            <button className="bg-blue-600 text-white h-[50px] rounded-full w-[200px] text-[16px] hover:bg-blue-700 transition-colors" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>
